    ...
    return (
        <section className="min-h-screen bg-black/90 py-16 px-4">
                        ...
                        <div className="text-white space-y-2">
                            ...
                            <p className="text-xs text-gray-400 mt-2">
                                Applied: {app.submittedAt? 
                                    dayjs(app.submittedAt._seconds ? new Date(app.submittedAt._seconds * 1000) : new Date(app.submittedAt)).fromNow()
                                : "Unknown"}
                            </p>
                        </div>
                    </motion.div>
            ...
            {!loading && apps.length === 0 && (
                <p className="text-center text-gray-400 text-lg mt-10">No applications yet.</p>
            )}
            ...
            {selected && (
                <div className="fixed inset-0 bg-black/80 backdrop-blur-lg flex items-center justify-center p-6 z-50">
                    ...
                    >
                        ...
                        {/* DATE INPUT */}
                        <div className="mb-6">
                            <label className="block mb-2 text-gray-300">Enter appointment date:</label>
                            <input
                                type="date"
                                value={grantDate}
